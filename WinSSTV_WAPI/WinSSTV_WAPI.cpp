...
void initUI(HWND parent) {    
    ListBox = CreateWindowW(L"listbox", L"", WS_CHILD | WS_VISIBLE | WS_VSCROLL | ES_AUTOVSCROLL | LBS_EXTENDEDSEL | WS_BORDER, 10, 10, 963, 400, parent, (HMENU)101, 0, 0);
    TextBox = CreateWindowW(L"Edit", L"", WS_VISIBLE | WS_CHILD | WS_BORDER | ES_MULTILINE | ES_WANTRETURN | ES_AUTOVSCROLL, 10, 400, 875, 25, parent, (HMENU)2, NULL, NULL);
    Button = CreateWindowW(L"Button", L"Submit", WS_VISIBLE | WS_CHILD | WS_BORDER, 893, 400, 80, 25, parent, (HMENU)1, NULL, NULL);
}
